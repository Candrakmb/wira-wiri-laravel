                        ...
                        <div class="card-body px-4 pb-3">
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-2" data-id="{{$item->id}}">
                                    <div class="row mt-2">
                                          @foreach ($kategoriMenu as $kategoriPilih)
                                          @if ($kategoriPilih->menu_id == $item->id)
                                          @php $count = 1; @endphp
                                          <div class="col-md-12 mt-2 mb-2">
                                            <div class="card card-plus mt-3">
                                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-3 pb-2">
                                                <div class="row">
                                                    <div class="col-md-6 pt-2">
                                                        <h6 class="text-white text-capitalize ps-3">Menu Opsi {{$kategoriPilih->nama}}</h6>
                                                    </div>
                                                    <div class="col-md-6 d-flex justify-content-end pe-4">
                                            ...
                                            <div class="card-body">
                                                <div class="row justify-content-md-center">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="hidden" name="new_id_kategori[]" value="{{$kategoriPilih->id}}">
                                                        <input type="hidden" name="kategori_id[]" value="{{$kategoriPilih->id}}">
                                                ...
                                                <div class="row mt-3"  data-id="{{$kategoriPilih->id}}">
                                                    @foreach ($menu_detail as $detail)
                                                    @if ($detail->kategori_pilih_menu_id  == $kategoriPilih->id)
                                                    <div class="col-md-6 mt-2">
                                                        <div class="card card-plus">
                                                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-3 pb-2">
                                                            <div class="row">
                                                                <div class="col-md-6 pt-2">
                                                                    <h6 class="text-white text-capitalize ps-3" {{$count}}>{{$detail->nama_pilihan}}</h6>
                                                                </div>
                                                                @if ($count > 1)
                                                                <div class="col-md-6 d-flex justify-content-end pe-4">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-12 mt-2">
                                                        ...
                                                        <input type="hidden" name="mark_id_kategori[]" value="{{$kategoriPilih->id}}">
                                                        <input type="hidden" name="id_detail[]" value="{{$detail->id}}">
                                                        <input type="text" id="nama_pilihan" placeholder="contoh: pedas" name="nama_pilihan[]" class="form-control input nama_pilihan"  value="{{$detail->nama_pilihan}}" required>
                                                        <p class="help-block" style="display: none;"></p>
                                                    </div>
                                                    <div class="col-md-6 mt-2">
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <input type="text" id="harga_pilihan" placeholder="contoh: 1000" name="harga_pilihan[]" class="form-control input" value="{{$detail->harga}}" required>
                                                        <p class="help-block" style="display: none;"></p>
                                                    </div>
                                                    <div class="col-md-12 mt-2">
